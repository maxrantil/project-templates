#!/usr/bin/env bash
# ABOUTME: Automates GitHub branch protection and repository settings setup
...
Automates GitHub repository branch protection and settings configuration.
...
main() {
    ...
    print_msg "$BLUE" "╔════════════════════════════════════════════╗"
    print_msg "$BLUE" "║  GitHub Repository Setup Script           ║"
    print_msg "$BLUE" "╚════════════════════════════════════════════╝"
    echo
